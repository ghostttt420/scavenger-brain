...
def load_sprite(filename, scale_size=None):
    # Try loading from the assets folder (generated by assets.py)
    ...
    # Fallback: Simple Box if generation fails
    surf = pygame.Surface(scale_size if scale_size else (40, 60), pygame.SRCALPHA)
    pygame.draw.rect(surf, (0, 0, 255), (0, 0, *scale_size), border_radius=5)
    return surf
...
class Car:
    ...
    def draw(self, screen, camera):
        ...
        # DYNAMIC SPRITE SWAP: Use Red car if Leader, Blue otherwise
